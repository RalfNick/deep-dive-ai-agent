...
## 2026-09-06 第八章 v1.4-rc2

第八章 71 项测试通过，比 rc1 增加 9 项：片段归属 2 项、标注边界 3 项、最终回查 2 项、请求 CLI 1 项、历史图兼容门禁 1 项。根级 43 项测试通过。真实请求可运行 `python -m chapter8.experiments.inspect_request`；不需要 API Key。未执行真实模型质量评估。
...
本轮仅更新本地候选，不表示网站已部署。第 1、3、4、5、6、7、8、9 章分别通过 10、20、24、63、143、65、62、47 项测试，共 434 项。新增 BM25/RRF 手算核对入口；第九章正文与 FAQ 分离，字数门槛对齐写作指南，其余门禁保留。未运行付费 API，也未重新执行第二章训练脚本。
