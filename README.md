...
- 简体中文是唯一权威正文，已发布第 1–7 章；第 1–6 章已完成复审，第 7 章已完成正文、实验与发布门禁。
- 第 1–7 章都包含配套实验、测试、固定报告或结果，以及参考答案。
- 第 8–18 章已进入写作规划，尚未发布正文。
...
| 第 7 章 记忆：不是把聊天记录全部塞回去 | [正文](book/chapter7.md) | [实验](chapter7/README.md) | [答案](chapter7/reference-answers.md) | [59 项测试通过](docs/EXPERIMENT_STATUS.md) |
