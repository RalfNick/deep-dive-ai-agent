...
围绕一组有版本冲突、权限隔离、过期内容与文档注入的领域问答文档，完成可治理 Catalog、三种切块、关键词与语义召回、RRF 融合、重排、Evidence Packet、引用、拒答、Catalog 回查和分层评估；明确 RAG 与 Context、Memory、Tool 的边界。实验使用 18 篇虚构知识文档和 20 个固定问题，无 API Key 即可复现。
